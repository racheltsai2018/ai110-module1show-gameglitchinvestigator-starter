...
The way I decide if a bug is really fixed is by runing the project again. I reenact the scene again to make sure the outcome is correct. If the outcome is the expected outcome, then the bug is fixed. 
